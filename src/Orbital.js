    ...
    init() {
      ...
      this.orbits.forEach((orbit, orbitIndex) => {
        ...
        orbit.items.forEach((item, itemIndex) => {
          ...
          itemDiv.style.animation = `${itemAnimationName} ${orbit.speed || 10}s linear infinite ${orbitIndex % 2 === 0 ? 'normal' : 'reverse'}`;
          ...
          imgDiv.style.boxShadow = '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)';
